...
<div class="page-header">
    <h1 class="page-title">✏️ Tambah Artikel Baru</h1>
    <p style="color: #666; margin-top: 0.5rem;">Buat artikel baru dan kelola kata-kata di dalamnya</p>
</div>
    ...
    <form method="POST" action="{{ route('admin.articles.store') }}" id="articleForm">
        ...
        <div style="padding: 1.5rem; border-bottom: 2px solid #f0f0f0;">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Contoh: Bilangan, Keluarga, Profesi" required>
                @error('title')
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="num" class="form-control @error('num') is-invalid @enderror" value="{{ old('num') }}" placeholder="Opsional">
                    @error('num')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div class="word-relation-item">
        ...
        <div style="display: flex; gap: 0.5rem; justify-content: space-between; align-items: center;">
            ...
            <small class="text-muted">
                ID Relasi akan dibuat setelah disimpan
            </small>
        </div>
    </div>
</template>
